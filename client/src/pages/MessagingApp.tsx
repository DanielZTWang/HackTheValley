...
const MessagingApp: React.FC = () => {
  ...
  <div className="flex flex-1 flex-col justify-end items-center bg-white/90 shadow-2xl border-l-4 border-r-4 border-pink-200 h-[80vh] max-h-[80vh] w-full overflow-y-auto rounded-2xl">
              ...
              .map((msg, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    {msg.image && (
                      <img src={msg.image} alt="uploaded" className="rounded-lg mt-2 max-w-[180px] max-h-[120px] border border-white shadow" />
                    )}
                  </div>
                );
              })}
